namespace jep_construction_api.Constants
{
    ...
    {
        public const string CREATE_PROJECT_MANAGEMENT_ACCOUNT_SUCCESS = "Create project management successfully created";
        public const string UPDATE_PROJECT_MANAGEMENT_SUCCESS = "Update prject management successfully";
